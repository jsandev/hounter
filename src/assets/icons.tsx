...
export const IconCall: React.FC<ISVG> = ({ width, height, className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M8.384 2.48a2.4 2.4 0 0 1 2.793 1.134l.09.18.793 1.764a2.996 2.996 0 0 1-.53 3.262l-.159.158-1.253 1.168c-.225.213-.056 1.04.761 2.454.733 1.272 1.332 1.866 1.625 1.898h.052l.063-.012 2.46-.752a1.8 1.8 0 0 1 1.877.53l.11.137 1.628 2.256a2.4 2.4 0 0 1-.15 2.997l-.146.15-.651.618a4.2 4.2 0 0 1-4.458.845c-2.322-.936-4.432-3.074-6.348-6.393-1.92-3.328-2.718-6.228-2.362-8.712a4.2 4.2 0 0 1 2.715-3.347l.231-.077.86-.259Z" />
  </svg>
);

export const IconEmail: React.FC<ISVG> = ({ width, height, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width || 24}
    height={height || 24}
