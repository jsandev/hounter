...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Hounter 🏡 | Encuentra el lugar para vivir tus sueños fácilmente aquí</title>
      </Head>
            ...
            <div className="flex flex-col items-center gap-[1rem]">
              <div className="flex flex-col">
                ...
                <p className="font-normal text-[1rem] text-[#626687] leading-[1.75rem] xs:pl-[2.5rem]">
                  Houses recommended by our partners that have been curated to become the home of
                  your dreams!
                </p>
              </div>
